...
read_file -format verilog  ../rtl/CRAdder_32.v
read_file -format verilog  ../rtl/FullAdder.v
read_file -format verilog  ../rtl/BoothStep.v
read_file -format verilog  ../rtl/Booth.v
read_file -format verilog  ../rtl/BoothSeq.v
analyze -library work -format verilog ../rtl/regN.v
analyze -library work -format verilog ../rtl/CRAdder_32.v
analyze -library work -format verilog ../rtl/FullAdder.v
analyze -library work -format verilog ../rtl/BoothStep.v
analyze -library work -format verilog ../rtl/Booth.v
analyze -library work -format verilog ../rtl/BoothSeq.v
